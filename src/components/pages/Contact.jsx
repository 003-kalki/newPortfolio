...
export default function Contact() {
  return (
    <section id="contact" className="bg-customGrey h-screen flex flex-col md:flex-row items-center justify-center gap-8 md:gap-24 px-8">
      {/* Left Section */}
  ...
  <a
    href="https://www.linkedin.com/in/shyam-sharma-ba19331b4/"
  ...
  <a
    href="https://www.reddit.com/user/kalki_3/"
